...
import type SourceMapBuilderFactory from './source-map-builder';

export default function ParseTreeFactory(SourceMapBuilder: ReturnType<typeof SourceMapBuilderFactory>) {
    class ParseTree {
